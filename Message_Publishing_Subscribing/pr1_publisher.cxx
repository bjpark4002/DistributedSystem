...
objs/<arch>/pr1_subscriber <domain_id> <sample_count>

(3) Start the publication with the command
objs/<arch>/pr1_publisher <domain_id> <sample_count>
...
objs/<arch>/pr1_publisher <domain_id> o
objs/<arch>/pr1_subscriber <domain_id> 

On Windows:

objs\<arch>\pr1_publisher <domain_id>  
objs\<arch>\pr1_subscriber <domain_id>    
...
extern "C" int publisher_main(int domainId, int sample_count)
{
    ...
    */
    ...
    /* Main loop */
    char maName[20]="---Bumjin Park---";
    char inputs[10][10] = {"Apple","Spinach","Carrots","Lentil","Banana","Potato","Pear","Avocado","Cherry","Orange"};

    for (count=0; (sample_count == 0) || (count < sample_count); ++count) {

        printf("Writing Msg, count %d\n", count);
        instance->sender=maName;
        instance->message=inputs[(count)%10];
        instance->Received=count;
